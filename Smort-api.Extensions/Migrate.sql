...
CREATE TABLE `Video` ( `Id` integer PRIMARY KEY AUTO_INCREMENT, `User_Id` integer, `File_Id` integer, `Title` varchar(32), `Description` varchar(128), `Created_At` DateTime, `Updated_At` DateTime, `Deleted_At` DateTime );
CREATE TABLE `Reaction` ( `User_Id` integer, `Video_Id` integer, `Created_At` DateTime, `Updated_At` DateTime );
CREATE TABLE `File` ( `Id` integer PRIMARY KEY AUTO_INCREMENT, `File_Name` varchar(128), `File_location` varchar(256), `Created_At` DateTime, `Deleted_At` DateTime );
